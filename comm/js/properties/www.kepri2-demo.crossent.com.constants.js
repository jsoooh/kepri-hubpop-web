...
angular.module('app')
    ...
    .constant('tenantChartConfig', [
        ...
        {
            id: 2,
            nodeid: 'cpu_load_usage',
            name: 'CPU Load 사용률',
            func: 'tenantCpuLoad1mList',
            type: 'lineChart',
            percent: false,
            axisLabel: '1m, 5m, 15m'
        },
    ...
    .constant('tenantNetChartConfig', [
        ...
        },
        {
            id: 3,
            nodeid: 'net_drop',
            name: '네트워크 Dropped Packet',
            func: 'tenantNetworkDroppedPacketList',
            type: 'lineChart',
            percent: false,
            axisLabel: 'Count'
        }
