...
angular.module('perf.services')
    .factory('perfAnlsService', function (common, CONSTANTS) {
        ...
        /* 대시보드 전체 사용 금액 BY ORGCODE - 화면 ID: HUBPOP_INT_PER_ANS_01 */
        perfAnlsService.sumTotalAnlsByOrg = function (params) {
            return common.retrieveResource(common.resourcePromise(CONSTANTS.uaaContextUrl + '/perf/anls/org/{orgCode}/summary/total', 'GET', params));
        };
