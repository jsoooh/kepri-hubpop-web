    ...
    function($controllerProvider, $provide, $compileProvider, $filterProvider, $injector, $animateProvider) {
      ...
      this.$get = ['$log', '$q', '$templateCache', '$http', '$rootElement', '$rootScope', '$cacheFactory', '$interval', function($log, $q, $templateCache, $http, $rootElement, $rootScope, $cacheFactory, $interval) {
        ...
        if(angular.isUndefined(jsLoader)) {
           ...
           * @param params object provider parameters
           * because the common can overwrite jsLoader and it will probably not use promises :(
           */
        ...
        if(angular.isUndefined(cssLoader)) {
           ...
           * @param callback to call when everything is loaded. We use a callback and not a promise
           * @param params object provider parameters
           * because the common can overwrite cssLoader and it will probably not use promises :(
           */
        ...
        if(angular.isUndefined(templatesLoader)) {
           ...
           * @param paths array list of css files to load
           * @param callback to call when everything is loaded. We use a callback and not a promise
           * @param params object provider parameters for $http
           * because the common can overwrite templatesLoader and it will probably not use promises :(
           */
        ...
        return {
          /**
           * Let you get a module provider object
          ...
          /**
           * Let you define a module provider object
           * @param moduleConfig Object the module provider object
           * @returns {*}
           */
          setModuleConfig: function(moduleConfig) {
            if(!angular.isObject(moduleConfig)) {
              throw new Error('You need to give the module provider object to set');
            }
           ...
           * @param module Mixed the name of a predefined module provider object, or a module provider object, or an array of either
