...
angular.module('gpu.controllers')
    ...
    .controller('gpuDeployServerCtrl', function ($scope, $location, $state, $stateParams,$mdDialog, $q, $filter, $timeout, user,paging, common, ValidationService, CONSTANTS) {
        // _DebugConsoleLog("computeControllers.js : iaasDeployServerCtrl", 1);
        _DebugConsoleLog("computeControllers.js : gpuDeployServerCtrl", 1);
        ...
        ct.formOpen = function () {
            ...
            $scope.main.layerTemplateUrl = _GPU_VIEWS_ + "/compute/computeTypeCreateStepForm.html" + _VersionTail();
        ...
        ct.moveToDetailPage = function(deployServer) {
            if (deployServer.viewType == "deploy") {
                ...
                $scope.main.goToPage('/gpu/deploy_server/detail/'+deployServer.deployId,deployServer.name)
            } else {
                // $scope.main.goToPage('/iaas/compute/detail/'+deployServer.id,deployServer.name)
                $scope.main.goToPage('/gpu/compute/detail/'+deployServer.id,deployServer.name)
            }
        };
        ...
        ct.fn.getDeployList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy', 'GET', params);
        ...
        ct.fn.deleteDeployServer = function(deployServer, index) {
            ...
            common.showConfirm('서비스 삭제', '선택한 서비스('+deployServer.name+') 및 서버를 삭제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    if (status == 200 && data) {
        ...
        ct.fn.addDeployServerInstance = function(deployServer, index, count) {
            ...
            common.showConfirm(title, message).then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/instance/scale', 'POST', param);
                returnPromise.success(function (data, status, headers) {
                    ct.fn.onlyDataReLoad();
                });
                returnPromise.error(function (data, status, headers) {
        ...
        ct.fn.delDeployServerInstance = function(deployServer, index, count) {
            ...
            common.showConfirm(title, message).then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/instance/scale', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    ct.fn.onlyDataReLoad();
                });
                returnPromise.error(function (data, status, headers) {
        ...
        ct.fn.deployServerInstanceCountFormOpen = function (deployServer, index) {
            var dialogOptions = {
                ...
                controller : "gpuDeployInstanceCountFormOpenCtrl",
        ...
        ct.fn.deployServerAction = function(action, deployServer, index) {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/action?' + $.param(param), 'POST');
            returnPromise.success(function (data, status, headers) {
                if (action == "START") {
    ...
    .controller('gpuDeployServerDetailCtrl', function ($scope, $location, $state, $sce, $q, $stateParams, $timeout, $window, $mdDialog, $filter, $bytes, $translate, user, common, ValidationService, CONSTANTS) {
        // _DebugConsoleLog("deployServerControllers.js : iaasDeployServerDetailCtrl", 1);
        _DebugConsoleLog("deployServerControllers.js : gpuDeployServerDetailCtrl", 1);
        ...
        ct.tabPathSettingTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployWebServicePath.html" + _VersionTail();
        // ct.tabDeployMonitTemplateUrl = _IAAS_VIEWS_ + "/compute/config/tabDeploySWMonit.html" + _VersionTail();
        ct.tabDeployMonitTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeploySWMonit.html" + _VersionTail();
        ...
        ct.fn.deployServerDetailAction = function(action) {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/action', 'POST', param);
            returnPromise.success(function (data, status, headers) {
                if (action == "START") {
                    common.showAlertError("서비스가 시작 되었습니다.");
                } else if(action == "STOP") {
            ...
            common.showConfirm('서비스 삭제', '선택한 서비스('+deployServer.deployName+') 및 서버를 삭제하시겠습니까?').then(function(){
                ...
                returnPromise.success(function (data, status, headers) {
                    setTimeout(function() {
                        ...
                        $scope.main.goToPage("/gpu/deploy_server");
                    }, 1000);
                });
                returnPromise.error(function (data, status, headers) {
                    $scope.main.loadingMainBody = false;
        ...
        ct.fn.getDeployServerInfo = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy', 'GET', param);
            returnPromise.success(function (data, status, headers) {
                $scope.main.loadingMainBody = false;
                if (data && angular.isArray(data.content) && data.content.length > 0) {
        ...
        ct.fn.listDeployHistory = function() {
            ...
            var serverStatsPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/history', 'GET', params);
            serverStatsPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content) && data.content.length > 0) {
        ...
        ct.fn.listActionLog = function() {
            ...
            var serverStatsPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/actionLog', 'GET', params);
            serverStatsPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content) && data.content.length > 0) {
        ...
        ct.fn.changeSltInfoTabSettingTemplateUrl = function () {
            if (ct.deployType == "LB") {
                ...
                ct.tabConfigSettingTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployLbServicePort.html" + _VersionTail();
                // ct.tabConfigDetailTemplateUrl = _IAAS_VIEWS_ + "/compute/config/tabDeployLbServicePortDetail.html" + _VersionTail();
                ct.tabConfigDetailTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployLbServicePortDetail.html" + _VersionTail();
                ...
                ct.tabConfigSettingTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployWebServiceConfig.html" + _VersionTail();
                // ct.tabConfigDetailTemplateUrl = _IAAS_VIEWS_ + "/compute/config/tabDeployWebServiceConfigDetail.html" + _VersionTail();
                ct.tabConfigDetailTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployWebServiceConfigDetail.html" + _VersionTail();
                ...
                ct.tabConfigSettingTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployWasServiceConfig.html" + _VersionTail();
                // ct.tabConfigDetailTemplateUrl = _IAAS_VIEWS_ + "/compute/config/tabDeployWasServiceConfigDetail.html" + _VersionTail();
                ct.tabConfigDetailTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployWasServiceConfigDetail.html" + _VersionTail();
                ...
                ct.tabConfigSettingTemplateUrl = _GPU_VIEWS_ + "/compute/config/tabDeployDbServiceConfig.html" + _VersionTail();
            }
        };
        ...
        ct.fn.addDomainLinkFormOpen = function (sltLbServicePort) {
            if (ct.deployServer.deployType)
                var dialogOptions = {
                    ...
                    controller : "gpuDeployDomainLinkFormCtrl",
                    callBackFunction : ct.fn.actionSebCallBackFun,
        ...
        ct.fn.modLbServicePortFormOpen = function (lbDeployServer, servicePort) {
            var dialogOptions = {
                ...
                controller : "gpuDeployLbServicePortFormCtrl",
                callBackFunction : ct.fn.actionSebCallBackFun,
        ...
        ct.fn.openResourceUploadForm = function (sltServiceInstance) {
            var dialogOptions = {
                ...
                controller : "gpuDeploySocuceFilePushFormCtrl",
                callBackFunction : ct.fn.actionSebCallBackFun,
        ...
        ct.fn.addLbServicePortLinkFormOpen = function (sltObject) {
            var dialogOptions = {
                ...
                controller : "gpuDeployLbServicePortLinkFormCtrl",
                callBackFunction : ct.fn.actionSebCallBackFun,
        ...
        ct.fn.delLbServerPortLink = function (lbServicePort) {
            common.showConfirm('서비스 포트 연결 해제','선택한 서비스 포트 연결을 해제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port/service', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    $scope.main.loadingMainBody = false;
                    if (status == 200) {
        ...
        ct.fn.delDomainLink = function (servicePortDomainLink) {
            common.showConfirm('도메인 연결 해제','선택한 도메인 연결을 해제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port/domain', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    $scope.main.loadingMainBody = false;
                    if (status == 200) {
    ...
    .controller('gpuComputeTypeCreateCtrl', function ($scope, $location, $state, $sce, $http, $translate, $stateParams,$timeout,$filter, $mdDialog, user, common, ValidationService, CONSTANTS) {
        // _DebugConsoleLog("deployServerControllers.js : iaasComputeTypeCreateCtrl start", 1);
        _DebugConsoleLog("deployServerControllers.js : gpuComputeTypeCreateCtrl start", 1);
        ...
        pop.fn.imageListSearch = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/server/image', 'GET');
            returnPromise.success(function (data, status, headers) {
        ...
        pop.fn.getDeployLbList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/type', 'GET', params);
            returnPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content) && data.content.length > 0) {
        ...
        pop.fn.getSoftwareList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/software', 'GET');
            returnPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content) && data.content.length > 0) {
                    angular.forEach(data.content, function(item, key) {
        ...
        pop.fn.getKeypairList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/server/keypair', 'GET', params);
            returnPromise.success(function (data, status, headers) {
...
*/
        ...
        pop.fn.getKeyFile = function(keypair, type) {
            ...
            document.location.href = CONSTANTS.gpuApiContextUrl + '/server/keypair/'+type+"?tenantId="+pop.userTenantId+"&name="+keypair.name;
        };
        ...
        pop.fn.networkListSearch = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/network/networks', 'GET', params);
            returnPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content) && data.content.length > 0) {
        ...
        pop.fn.getPublicIpList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/network/floatingIps', 'GET', params);
            returnPromise.success(function (data, status, headers) {
                if (data && angular.isArray(data.content)) {
        ...
        pop.fn.publicIpAllotment = function(type) {
            common.showConfirm('공인IP 할당', '공인IP를 추가 할당 하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/network/floatingIps', 'POST', params);
                returnPromise.success(function (data, status, headers) {
        ...
        pop.fn.getUnusingDomainList = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/network/domain/tenant/unusing', 'GET', params);
            returnPromise.success(function (data, status, headers) {
        ...
        pop.fn.createCPServer = function(evt, instance) {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/server/instance', 'POST', {instance : instance});
            returnPromise.success(function (data, status, headers) {
        ...
        pop.fn.createSystemServer = function(evt, systemSwObject) {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy', 'POST', systemSwObject);
            returnPromise.success(function (data, status, headers) {
                pop.fn.createTypeServerSuccessCallBack(evt, data);
            });
            returnPromise.error(function (data, status, headers) {
    ...
    .controller('gpuDeployInstanceCountFormOpenCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, ValidationService, common, CONSTANTS) {
       //  _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployInstanceCountFormOpenCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployInstanceCountFormOpenCtrl", 1);
        var pop = this;
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/deployInstanceCountForm.html" + _VersionTail();
        ...
        pop.fn.setDeployInstanceCount = function () {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/instance/scale', 'PUT', param);
            returnPromise.success(function (data, status, headers) {
                if (status == 200) {
                    $timeout(function () {
