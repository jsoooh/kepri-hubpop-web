...
angular.module('gpu.controllers')
    ...
    .controller('gpuDeployLbServicePortFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, popType, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployLbServicePortFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployLbServicePortFormCtrl", 1);
        ...
        dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployLbServicePortForm.html" + _VersionTail();
        ...
        portPop.fn.pushLbServicePort = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port', method, param);
    ...
    .controller('gpuDeployLbServicePortLinkFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployLbServicePortLinkFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployLbServicePortLinkFormCtrl", 1);
        var pop = this;
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployLbServicePortLinkForm.html" + _VersionTail();
        ...
        pop.fn.addDeployLbServicePortLink = function () {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port/service', 'POST', param);
            returnPromise.success(function (data) {
                $scope.main.loadingMainBody = false;
                $scope.actionBtnHied = false;
                if (data && angular.isDefined(data.content)) {
    ...
    .controller('gpuDeployDomainLinkFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployDomainLinkFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployDomainLinkFormCtrl", 1);
        var pop = this;
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployDomainLinkForm.html" + _VersionTail();
        ...
        pop.fn.addDomainLink = function () {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port/domain', 'POST', params);
            returnPromise.success(function (data) {
                $scope.main.loadingMainBody = false;
                $scope.actionBtnHied = false;
                if (data && angular.isDefined(data.content)) {
    ...
    .controller('gpuDeployWebServiceConfigFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployWebServiceConfigFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployWebServiceConfigFormCtrl", 1);
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployWebServiceConfigForm.html" + _VersionTail();
        ...
        pop.fn.pushWebServiceInstanceConfig = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/service_instance', method, param);
            returnPromise.success(function (data) {
                $scope.main.loadingMainBody = false;
                $scope.actionBtnHied = false;
                if (data && angular.isDefined(data.content)) {
    ...
    .controller('gpuDeployWebServicePathFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployWebServicePathFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployWebServicePathFormCtrl", 1);
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployWebServicePathForm.html" + _VersionTail();
        ...
        pop.fn.getLbDeployServerList = function() {
            ...
            var serverStatsPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/type', 'GET', params);
        ...
        pop.fn.addWebServicePath = function() {
            ...
            var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/service_instance/path', 'POST', param);
            returnPromise.success(function (data) {
                $scope.main.loadingMainBody = false;
                $scope.actionBtnHied = false;
                if (data && angular.isDefined(data.content)) {
    ...
    .controller('gpuDeployWasServiceConfigFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployWasServiceConfigFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployWasServiceConfigFormCtrl", 1);
        var pop = this;
        pop.validationService = new ValidationService({controllerAs : pop});
        pop.fn = {};
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployWasServiceConfigForm.html" + _VersionTail();
    ...
    .controller('gpuDeploySocuceFilePushFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerControllers.js : iaasDeploySocuceFilePushFormCtrl", 1);
        _DebugConsoleLog("deployServerControllers.js : gpuDeploySocuceFilePushFormCtrl", 1);
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeploySocuceFilePushForm.html" + _VersionTail();
        ...
        pop.fn.deploySourceFilePush = function() {
            ...
            var returnPromise = common.noMsgRetrieveResource(common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/service_instance/resource', 'PUT', param, contentType));
    ...
    .controller('gpuDeployDbServiceConfigFormCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, ValidationService, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerConfigFormControllers.js : iaasDeployDbServiceConfigFormCtrl", 1);
        _DebugConsoleLog("deployServerConfigFormControllers.js : gpuDeployDbServiceConfigFormCtrl", 1);
        var pop = this;
        pop.validationService = new ValidationService({controllerAs : pop});
        pop.fn = {};
        ...
        $scope.dialogOptions.templateUrl = _GPU_VIEWS_ + "/compute/config/popDeployDbServiceConfigForm.html" + _VersionTail();
