...
angular.module('gpu.controllers')
    ...
    .controller('gpuDeployLbServicePortTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployLbServicePortTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployLbServicePortTabCtrl", 1);
        ...
        tab.fn.deleteLbServicePort = function(servicePort) {
            ...
            common.showConfirm('LB 포트 삭제', 'LB 포트('+servicePort.servicePortName+')를 삭제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/port', 'DELETE', param);
    ...
    .controller('gpuDeployWebServiceConfigTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployWebServiceConfigTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployWebServiceConfigTabCtrl", 1);
        ...
        tab.fn.addWebServiceInstanceFormOpen = function () {
            var dialogOptions = {
                ...
                controller : "gpuDeployWebServiceConfigFormCtrl",
                callBackFunction : tab.fn.actionCallBackFun,
                deployServer : angular.copy($scope.contents.deployServer),
                controllerAs : "pop",
                formMode : "add"
        ...
        tab.fn.delWebServiceInstance = function(serviceInstance) {
            ...
            common.showConfirm('WEB 서비스 삭제', 'WEB 서비스('+serviceInstance.serviceInstanceName+')를 삭제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/service_instance', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    $scope.main.loadingMainBody = false;
                    if (status == 200) {
                        if ($scope.contents.configDetailView) {
        ...
        tab.fn.addWebServiceInstanceLocationForm = function (sltServiceInstance) {
            var dialogOptions = {
                ...
                controller : "gpuDeployWebServicePathFormCtrl",
                callBackFunction : tab.fn.actionCallBackFun,
                deployServer : angular.copy($scope.contents.deployServer),
                serviceInstance : angular.copy(sltServiceInstance),
                controllerAs : "pop",
        ...
        tab.fn.delWebServiceInstanceLocation = function(serviceLocation) {
            common.showConfirm('WEB 리소스 삭제', 'WEB 리소스 ('+serviceLocation.name+')를 삭제하시겠습니까?').then(function(){
                ...
                var returnPromise = common.resourcePromise(CONSTANTS.gpuApiContextUrl + '/deploy/deploy/service_instance/path', 'DELETE', param);
                returnPromise.success(function (data, status, headers) {
                    $scope.main.loadingMainBody = false;
                    if (status == 200) {
    ...
    .controller('gpuDeployWebServicePathTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployWebServicePathTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployWebServicePathTabCtrl", 1);
    ...
    .controller('gpuDeployWasServiceConfigTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployWasServiceConfigTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployWasServiceConfigTabCtrl", 1);
        ...
        tab.fn.addWasServiceInstanceFormOpen = function () {
            var dialogOptions = {
                ...
                controller : "gpuDeployWasServiceConfigFormCtrl",
                callBackFunction : tab.fn.actionCallBackFun,
                deployServer : angular.copy($scope.contents.deployServer),
                controllerAs : "pop",
                formMode : "add"
    ...
    .controller('gpuDeployWasServiceConfigDetailTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployWasServiceConfigDetailTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployWasServiceConfigDetailTabCtrl", 1);
    ...
    .controller('gpuDeployDbServiceConfigTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerTabControllers.js : iaasDeployDbServiceConfigTabCtrl", 1);
        _DebugConsoleLog("deployServerTabControllers.js : gpuDeployDbServiceConfigTabCtrl", 1);
        ...
        tab.fn.modDbServiceInstanceConfigFormOpen = function (sltServiceInstance) {
            var dialogOptions = {
                ...
                controller : "gpuDeployDbServiceConfigFormCtrl",
                callBackFunction : tab.fn.actionCallBackFun,
                deployServer : angular.copy($scope.contents.deployServer),
                serviceInstance : angular.copy(sltServiceInstance),
                controllerAs : "pop",
    ...
    .controller('gpuDeploySWMontiTabCtrl', function ($scope, $location, $state, $translate, $filter, $mdDialog, $timeout, common, CONSTANTS) {
        // _DebugConsoleLog("deployServerControllers.js : iaasDeploySWMontiTabCtrl", 1);
        _DebugConsoleLog("deployServerControllers.js : gpuDeploySWMontiTabCtrl", 1);
